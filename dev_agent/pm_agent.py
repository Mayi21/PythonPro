...
log_handler = TimedRotatingFileHandler('../logs/pm_agent_app.log', when='midnight', interval=1, backupCount=14)
...
async def deploy_host(port_item: PortItem):
    ...
    print('{} {}:8000 --env PM_IP={} --env PM_PORT={} --env SERVER={} --name agent_{} agent-plugin'.format(
        ...
        SERVER,
        vm_port))
    out = __exec_cmd('{} {}:8000 --env PM_IP={} --env PM_PORT={} --env SERVER={} --name agent_{} agent-plugin'.format(
        DockerCMD.RUN_VM.value,
        vm_port,
        pm_ip,
        pm_port,
